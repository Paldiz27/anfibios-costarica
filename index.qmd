...
colores_riqueza_especies <-
  colorNumeric(
    palette = "Reds",
    domain = riqueza_especies_anfibios$riqueza_especies,
...
addPolygons(
    ...
    fillColor = ~ colores_riqueza_especies(riqueza_especies),
    fillOpacity = 0.8,
    color = "black",
    stroke = TRUE,
    weight = 1.0,
    popup = paste(
      paste("<strong>Área de conservación:</strong>", riqueza_especies_anfibios$nombre_ac),
      paste("<strong>Riqueza de especies:</strong>", riqueza_especies_anfibios$riqueza_especies),
      sep = '<br/>'
    ),
  ...
  addLegend(
    ...
    values = conserva_union_riqueza$riqueza_especiess,
    group = "Riqueza de especies",
